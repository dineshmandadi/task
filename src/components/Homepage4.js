...
const Homepage4 = () => {
  ...
  return (
   ...
   <a href='#img'><img onClick='this.dinesh'src='https://panorbit.in/wp-content/uploads/2019/hotlink-ok/1005.jpeg'   style={{width:'30px',height:'30px',borderRadius:'20px',marginLeft:'700px',marginTop:'20px'}}></img></a>
    <h5 style={{margintop:'20px',marginLeft:'5px'}}>Clementine Bauch</h5>
    </div>
    <hr style={{width:'940px'}}></hr>
    <div className='pra' style={{marginLeft:'100px'}}>
    <img src="https://panorbit.in/wp-content/uploads/2019/hotlink-ok/1005.jpeg" style={{height:"150px",width:"150px",borderRadius:"50%"}}></img>
</div>
    <div className="prav" style={{marginLeft:'100px'}}>
      <b style={{fontSize:'20px'}}>Clementine Bauch</b>  
